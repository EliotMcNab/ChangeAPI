...
/**
 * Sequential implementation of {@link ReplaceLastIf} where {@link java.util.function.Predicate Predicate} are applied
 * consecutively to avoid looping through an array multiple times
 * @param <E> the type the {@link SingleThreadChange} operates on
 */
public class SequentialReplaceLastIf<E> extends ReplaceBase<E> {
    ...
    public SequentialReplaceLastIf(
            final Class<E> clazz,
    ...
    protected E[] applyToImpl(E[] array) {
        ...
        while (--i >= 0 && matchCount != changes.length) {
    ...
    public String toString() {
        return "SequentialReplaceLastIf{changes=" +
